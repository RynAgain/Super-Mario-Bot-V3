...
class PerformancePlotter:
    ...
    def start_realtime_monitoring(self, enable_plotting: bool = False):
        """Start real-time monitoring dashboard."""
        if not enable_plotting:
            self.logger.info("Real-time plotting disabled - skipping monitoring dashboard")
            return
    ...
    def create_static_analysis(self, output_path: Optional[str] = None, enable_plotting: bool = False) -> str:
        """
        Create static analysis plots and save to file.
        
        Args:
            output_path: Output file path
            enable_plotting: Whether to enable plotting (default False for training runs)
            
        Returns:
            Path to saved analysis file
        """
        if not enable_plotting:
            self.logger.info("Plotting disabled - skipping static analysis")
            return ""
